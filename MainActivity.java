...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        p1Name = bundle.getString("p1_name");
        p2Name = bundle.getString("p2_name");
    ...
    private void doStuff(ImageView iv, int card) {
        ...
        //check which image is selected and save it tempory variable
        if (cardNumber == 1) {
            ...
            alertDialogBuilder
                    ...
                    .setNeutralButton("REPLAY ", new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            ...
                            Bundle bundle = new Bundle();
                            bundle.putString("p1_name", p1Name);
                            bundle.putString("p2_name", p2Name);
                            intent.putExtras(bundle);
                            startActivity(intent);
